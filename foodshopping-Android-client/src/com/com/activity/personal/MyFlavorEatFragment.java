...
public class MyFlavorEatFragment extends Fragment implements OnItemClickListener, IXListViewListener{
		private View mView;
...
//		public static final String BASE_URL = "http://192.168.1.193/foodshopping-servers/";
		...
		public MyFlavorEatFragment(Handler handler) {
			this.addBasketHandler = handler;
			
		}

		public MyFlavorEatFragment() {
		}
						...
						.setPositiveButton("是", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								...
								new Thread(){
									...
									public void run() {
										try{
											String url = BaseUrl.BASE_URL + "/servlet/MyFlavorEatDeleteServlet?cate_id=" +shoppingCates.get((int)id).getCate_id();;
		...
		class GetDataThread extends Thread {
			...
			public GetDataThread(int minRow,boolean isRefresh) {
				MyFlavorEatFragment.this.minRow = minRow;
			...
			public void run() {
				try {
					 String url = BaseUrl.BASE_URL + "/servlet/MyFlavorEatServlet";
					 url = BaseUrl.BASE_URL + "/servlet/MyFlavorEatServlet"  ;
					String strJson = HttpUtil.getRequest(url);
					Gson gson = new Gson();
					Type type = new TypeToken<ArrayList<ShoppingCate>>(){}.getType();

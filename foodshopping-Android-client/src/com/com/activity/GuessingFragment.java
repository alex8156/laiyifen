...
import com.com.activity.GuessingFragment.ProductAdapter.ViewHolder;
...
public class GuessingFragment extends Fragment implements OnItemClickListener, IXListViewListener {
	private View mView;
	...
	public GuessingFragment(Handler addBasketHandler) {
		super();
	...
	class GetDataThread extends Thread {
		...
		public GetDataThread(int minRow,boolean isRefresh) {
			GuessingFragment.this.minRow = minRow;
		...
		public void run() {
			...
			try {
				String url = BaseUrl.BASE_URL + "/ProductListServlet?maxRow=" + maxRow +"&minRow=" + minRow;
						...
						public void run() {
							try {
								...
								if (user_id == 0) {
									...
									//http://192.168.1.234/foodshopping-servers/AddToBasketServlet?cate_name=山椒凤爪&cate_price=20&user_id=1

...
import com.com.activity.RankingFragment.ProductAdapter.ViewHolder;
...
public class RankingFragment extends Fragment implements OnItemClickListener, IXListViewListener {
	private View mView;
	...
	public RankingFragment(Handler addBasketHandler) {
		super();
	...
	class GetDataThread extends Thread {
		...
		public GetDataThread(int minRow,boolean isRefresh) {
			RankingFragment.this.minRow = minRow;

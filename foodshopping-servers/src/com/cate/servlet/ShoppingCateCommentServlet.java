...
public class ShoppingCateCommentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			ArrayList<ShoppingCateComment> shoppingCateComments = userService.querryShoppingCateComment(cate_id);
			Gson gson = new Gson();
			String strJson = gson.toJson(shoppingCateComments);
			out.write(strJson);
		} catch (Exception e) {
